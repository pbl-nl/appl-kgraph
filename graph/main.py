...
async def ask_with_lightrag(question: str, verbose: bool = False, conversation_history=None) -> None:
    """
...
def main():
    ...
    while query not in ("exit", "quit"):
        ...
        print("\n---\n")
        print("\n--- LightRAG Response ---\n")
        result = asyncio.run(ask_with_lightrag(query, verbose=True, conversation_history=conversation_history))
